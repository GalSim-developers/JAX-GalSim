...
[![Contributor Covenant](https://img.shields.io/badge/Contributor%20Covenant-2.1-4baaaa.svg)](code_of_conduct.md) [![Python package](https://github.com/GalSim-developers/Galaxim/actions/workflows/python_package.yaml/badge.svg)](https://github.com/GalSim-developers/Galaxim/actions/workflows/python_package.yaml) [![Code style: black](https://img.shields.io/badge/code%20style-black-000000.svg)](https://github.com/psf/black)
...
In fact, we are still thinking about how to name this project, checkout [this poll](https://github.com/GalSim-developers/Galaxim/discussions/2).
...
- Ask or Answer questions on the [Discussions Q&A](https://github.com/GalSim-developers/Galaxim/discussions/categories/q-a) page
- Report a bug by opening a [GitHub issue](https://github.com/GalSim-developers/Galaxim/issues)
- Open a [GitHub issue](https://github.com/GalSim-developers/Galaxim/issues) or [Discussions](https://github.com/GalSim-developers/JAXGalaximscussions) to ask for feedback on a planned contribution.
