...
from galsim_test_helpers import timer, assert_raises, check_pickle, drawNoise
...
def test_variable_gaussian_noise():
    ...
    # NOTE had to turn down precision to 0 due to different RNG
    np.testing.assert_almost_equal(
