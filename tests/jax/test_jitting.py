...
def test_gaussian_jitting():
    ...
    objects = [galsim.Gaussian(half_light_radius=1., flux=0.2,
                               gsparams=gsparams),
...
def test_gaussian_jitting():
    # Test Gaussian objects
    objects = [galsim.Exponential(half_light_radius=1., flux=0.2,
                                  gsparams=gsparams),
    ...
    def test_eq(self, other):
        return (self.scale_radius == other.scale_radius and
                self.flux == other.flux and
                self.gsparams == other.gsparams)
...
def test_sum_jitting():
    obj1 = galsim.Gaussian(half_light_radius=1., flux=0.2,
                           gsparams=gsparams)
    obj2 = galsim.Exponential(half_light_radius=1., flux=0.2,
                              gsparams=gsparams)

    obj = obj1 + obj2

    def test_eq(self, other):
        return (self.obj_list == other.obj_list and
