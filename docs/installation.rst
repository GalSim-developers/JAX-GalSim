...
JAX-GalSim inherits GPU support from JAX. To use NVIDIA GPUs, install the
appropriate JAX variant:
...
for other accelerators and platform-specific instructions.
...
See `CONTRIBUTING.md <https://github.com/GalSim-developers/JAX-GalSim/blob/main/CONTRIBUTING.md>`_
